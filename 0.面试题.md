...
- ## 原型链
    ...
    ```
    > 备注：`Object.hasOwnProperty()` 表示 对象自身属性中是否具有指定的属性 （ [MDN文档](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Object/hasOwnProperty) ）
